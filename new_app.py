...
# Print first 5 paragraph chunks to verify
print(f"{'='*80}")
...
template = """
You are an expert sports analyst and commentator with deep knowledge of various sports. 
Your task is to answer questions based ONLY on the provided context from a sports document.

**Instructions:**
1. Use ONLY the information from the context to answer the question
2. If the context doesn't contain the answer, clearly state "I don't have information about that in the document"
3. Provide specific details, statistics, or facts when available
4. Keep your response concise but informative (2-4 sentences)
5. If multiple sports are mentioned, be specific about which sport you're referring to
...
# Initialize the free Gemini model tier - using the working model name from your older code
